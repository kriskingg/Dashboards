...
two-server, code/data/recovery/security/cleanup view.

Fresh Server-1 evidence is in [SERVER1_RUNTIME_VERIFICATION_2026-09-19.md](docs/SERVER1_RUNTIME_VERIFICATION_2026-09-19.md).
...
The private ETF/Kotak dashboard is a separate system on a second OCI VM,
